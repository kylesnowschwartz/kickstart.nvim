...
function TerminalBufferPreviewer:new(opts)
  ...
  return previewers.new_buffer_previewer {
    ...
    define_preview = function(self, entry, status)
      ...
      -- Get buffer lines and info for contex
      ...
      -- Calculate how many lines we should show based on window heigh
      ...
      -- Highlight the selected line if we found i
